...
stimuli = [x for x in os.listdir(".../contexts_of_bottini_stimuli")] #take the stimuli
...
def shrink(stimulus): #defining a function that will take a random 100k contexts for those words that have more contexts than that
    stimulus_path = f".../contexts_of_bottini_stimuli/{stimulus}" #path to the stimulus where the contexts are stored
